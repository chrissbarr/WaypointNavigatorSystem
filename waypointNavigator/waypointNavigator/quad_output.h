...
#define THROTTLE_OUT OCR4A	//PH3 DP6
#define AILERON_OUT OCR4B	//PH4 DP7
#define ELEVATOR_OUT OCR4C	//PH5 DP8
#define RUDDER_OUT OCR3A	//PE3 DP5
#define GEAR_OUT OCR3B		//PE4 DP2
#define AUX_OUT OCR3C		//PE5 DP3
